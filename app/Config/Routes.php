...
$routes->get('/reports/transaction/', 'Reports\ReportTransaction::index');
$routes->get('/reports/transaction/search', 'Reports\ReportTransaction::search');
$routes->get('/reports/transaction/(:any)', 'Reports\ReportTransaction::detail/$1');
$routes->get('/reports/income', 'Reports\ReportIncome::index');
$routes->get('/reports/income/search', 'Reports\ReportIncome::search');
