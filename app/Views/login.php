    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form action="index.php" method="post">
                ...
                <div class="form-group <?= ($validation->hasError('password')) || session()->getFlashdata('wrong_pass') ? 'has-error' : 'has-feedback' ?> ">
                    <input type="password" class="form-control" placeholder="Password" id="password" name="password">
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    <span class="help-block"><?= ($validation->hasError('password')) ? $validation->getError('password') : session()->getFlashdata('wrong_pass'); ?></span>
                </div>
                <div class="row">
                    <!-- <div class="col-xs-8">
