            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="/products/items/edit/<?= $item['barcode']; ?>" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="col-md-6">
                                            <!-- text input -->
                                            <div class="form-group <?= ($validation->hasError('item')) ? 'has-error' : 'has-feedback' ?>">
                                                <label>Product Name *</label>
                                                <input type="text" id="item" name="item" class="form-control" placeholder="Enter ..." value="<?= (set_value('item')) ? set_value('item') : $item['product']; ?>">
                                            ...
                                            <div class="form-group <?= ($validation->hasError('supplier')) ? 'has-error' : 'has-feedback' ?>">
                                                ...
                                                <select class="form-control select2" style="width: 100%" id="supplier" name="supplier">
                                                    ...
                                                    <?php foreach ($suppliers as $supplier) : ?>
                                                        <option value="<?= $supplier['id']; ?>" <?= ($item['supplier_id'] == $supplier['id']) ? 'selected' : ''; ?>><?= $supplier['supplier_company']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                                <span class="help-block">
                                            ...
                                            <div class="form-group <?= ($validation->hasError('product_image')) ? 'has-error' : 'has-feedback' ?>">
                                                <div class="col-sm-4" style="padding-left: 0;">
                                                    <img src="../../../image/products/<?= $item['product_image'] ?>" class="img-thumbnail img-preview" alt="">
                                                </div>
                                                <div class="col-sm-8">
                                                    <input type="file" id="product_image" name="product_image">
                                                    <input type="hidden" value="<?= $item['product_image']; ?>" name="old_image" id="old_image">
                                                    <span class="help-block">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group <?= ($validation->hasError('stock')) ? 'has-error' : 'has-feedback' ?>">
                                                <label>Stock *</label>
                                                <input type="number" min="1" id="stock" name="stock" class="form-control" placeholder="Enter ..." value="<?= (set_value('stock')) ? set_value('stock') : $item['stock']; ?>">
                                                <span class="help-block">
                                            ...
                                            <div class="form-group <?= ($validation->hasError('price')) ? 'has-error' : 'has-feedback' ?>">
                                                <label>Price *</label>
                                                <input type="number" min="0" id="price" name="price" class="form-control" placeholder="Enter ..." value="<?= (set_value('price')) ? set_value('price') : $item['price']; ?>">
                                                <span class="help-block">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="description" name="description" rows="3"><?= (set_value('description')) ? set_value('description') : $item['description']; ?></textarea>
